...
Tests are defined in the `applicants/tests` folder in this project. Use NPM to install the [Mocha test framework](https://mochajs.org/) and run unit tests.

```bash
lambda-nodejs18.x$ cd applicants
applicants$ npm install
applicants$ npm run test
```
